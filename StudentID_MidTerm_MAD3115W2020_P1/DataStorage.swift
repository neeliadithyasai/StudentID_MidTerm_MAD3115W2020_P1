...
class DataStorage {
    ...
    func loadCustomers(){
        do{
            ...
            let C1 = try Customer(customerId: "C101", firstName: "rob", lastName: "stark", email: "rob.s@gmail.com")
            let C2 = try Customer(customerId: "C102", firstName: "paul", lastName: "walker", email: "walker.paul@yahoo.com")
            let C3 = try Customer(customerId: "C103", firstName: "dan", lastName: "cooper", email: "cooper123@gmail.IO")
            customers.append(C1)
            customers.append(C2)
            customers.append(C3)
            ...
            let H1 = Hydro(billId: "HYD001", billDate: hd1!, billType: BillType.Hydro, billAmount: 280.90, agencyName: "Tyrant Energy", unitsConsumed: 350)
