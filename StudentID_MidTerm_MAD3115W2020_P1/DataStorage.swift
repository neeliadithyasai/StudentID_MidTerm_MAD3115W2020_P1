...
class DataStorage {
   ...
   func loadCustomers(){
        do{
            let C1 = try Customer(customerId: "C001", firstName: "rob", lastName: "stark", email: "rob.s@gmail.com")
            let C2 = try Customer(customerId: "C002", firstName: "simon", lastName: "baker", email: "simon@yahoo.com")
            let C3 = try Customer(customerId: "C003", firstName: "taylor", lastName: "hues", email: "taylor123@gmail.IO")
            customers.append(C1)
            customers.append(C2)
            customers.append(C3)
